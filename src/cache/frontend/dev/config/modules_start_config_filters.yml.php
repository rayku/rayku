...
list($class, $parameters) = (array) sfConfig::get('sf_rememberMeFilter_filter', array('RememberMeFilter', null));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);

list($class, $parameters) = (array) sfConfig::get('sf_userActifity_filter', array('UserActivityFilter', null));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);
