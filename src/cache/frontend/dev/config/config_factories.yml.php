...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/rayku/v0.4/src/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/rayku/v0.4/src/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('rayku_frontend'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/rayku/v0.4/src/cache/frontend/dev/template',
  'lifetime' => 86400,
