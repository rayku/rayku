...
//            '_checkOnlineUsers' => $_checkOnlineUsers,
//            'course_id' => $course_id,
//            'rankCheckUsers' => $rankCheckUsers
        )
    );
?>
</div>
...
var rayku_tutor_pag = jQuery.noConflict();
	...
	rayku_tutor_pag('span#ratesort').livequery("click", function(e){
		...
		rayku_tutor_pag.post("/tutorsList/append?show_more_post=15&rate="+rate_get, {
...
rayku_tutor_pag(document).ready(function(){	
	...
	rayku_tutor_pag.post("/tutorsList/append?show_more_post=15", {
