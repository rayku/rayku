...
<div class="entry" id="message<?php echo $message->getId(); ?>">
  <div class="container"> <?php echo link_to($message->getRecipient()->getName(), '@profile?username='.$message->getRecipient()->getUsername(),array('class'=>'author')); ?>
    <div class="date"><?php echo $message->getFormattedDate(); ?></div>
  </div>
  <div class="desc"> <?php echo link_to($message->getSubject(), 'message/read?id='.$message->getId()); ?> </div>
