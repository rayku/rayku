  ...
  <div class="body-main"> <?php echo form_tag('@new_thread?forum_id='.$category->getID()); ?>
    <div class="box">
      ...
      <?php if($_GET[exp_online]==1):?>
        ...
        <div class="content-info">
          <h1 class="info" style="font-size:16px; font-weight:normal; margin-top:10px;">Topic  (25 words or less): <?php if($title_error<>''){echo '<span class="error">('.$title_error.' )</span>';}?></h1>
	...
	<?php if(!empty($_COOKIE["forumsub"]) || $_GET['exp_online']==1 || $_GET['pob']==1) : ?>
       ...
       <?php else : ?>
		...
		<input name="thread_title" id="thread_title" value="<?=$_POST["thread_title"]?>" size="30" type="text" style="color:#000000"> 
	...
	<h1 class="info" style="font-size:16px; font-weight:normal; margin:25px 0 15px 0">Topic Full Description: <?php if($desc_error<>''){echo '<span class="error">('.$desc_error.')</span>';}?>	</h1>
