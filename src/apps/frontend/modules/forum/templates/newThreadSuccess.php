        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="content-info">
                    <h1 class="info" style="font-size:16px; font-weight:normal; margin-top:10px;">Topic  (25 words or less): <?php
                if (@$title_error <> '') {
                ...
                ?></h1>
                    ...
                    <?php if (!empty($_COOKIE["forumsub"]) || @$_GET['exp_online'] == 1 || @$_GET['pob'] == 1) { ?>
                        ...
                        <input name="thread_title" id="thread_title" value="<?php
                        if (!empty($_SESSION['course_name_sess'])) {
                            echo '[' . $_SESSION['course_name_sess'] . ']';
                        }
                        ?> <?php echo $_SESSION['question']; ?>" size="30" type="text" style="color:#000000"> 
                        ...
                        ?>
                    <?php } else { ?>
                        <input name="thread_title" id="thread_title" value="<?php echo @$_POST["thread_title"] ?>" size="30" type="text" style="color:#000000"> 
<?php } ?>


                    <?php if ($User->getType() == 5) { ?>

                        <label style="font-size:14px;font-weight:normal;color:#333"><input type='checkbox' name='stickie' id='stickie' value='1' style="width:25px;margin:0 0 20px 0;height:10px;" />Create this thread as a 'stickie' announcement</label>

                        <?php } ?>



                    <h1 class="info" style="font-size:16px; font-weight:normal; margin:25px 0 15px 0">Topic Full Description: <?php
                        if (@$desc_error <> '') {
                            echo '<span class="error">(' . $desc_error . ')</span>';
                        }
                        ?>	</h1>

<?php echo textarea_tag('post_body', @$_POST["post_body"], array('size' => '60x35', 'rich' => 'fck')); ?>
                </div>
                <!--content-info-->
