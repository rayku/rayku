...
class forumActions extends sfActions
{
    ...
    public function executeThread()
    {
        if($_GET['follow']<>'' and $_GET['expert_id']<>'')
        {
            ...
            $query = mysql_query("select * from expert_subscribers where expert_id = ".$expertid." and user_id =".$userid, $connection) or die(mysql_error());

            if(mysql_num_rows($query) == 0) {

                mysql_query("insert into expert_subscribers(expert_id, user_id) values('".$expertid."', '".$userid."')", $connection) or die(mysql_error());
        ...
        if($_GET['report']<>'')
        {
            ...
            if($_GET['thread_id']<>'')
            {
                ...
                $query = mysql_query("select * from thread where id = ".$thread_id." and  reported=1", $connection) or die(mysql_error());
            ...
            if($_GET['post_id']<>'')
            {
                ...
                $query = mysql_query("select * from post where id = ".$post_id." and  reported=1", $connection) or die(mysql_error());
