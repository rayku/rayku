<?php
mysql_connect("localhost","rayku","6)c%TU0%zr]s") or die(mysql_error()); //database connection
mysql_select_db("rayku_db")or die(mysql_error());//database name
$message="test status"; //facebook status to post
$redirect="http://www.rayku.com/dashboard"; //redirect after complete
...
$process_url="http://www.rayku.com/dashboard/processprofile"; //process file
?>