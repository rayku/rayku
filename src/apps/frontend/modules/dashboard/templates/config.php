...
$redirect = RaykuCommon::getCurrentHttpDomain() . "/dashboard"; //redirect after complete
...
$process_url = RaykuCommon::getCurrentHttpDomain() . "/dashboard/processprofile"; //process file
?>
