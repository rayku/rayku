		...
		<div class="widget">
			...
			<div class="widget-main">
				...
				<ul class="icon-list">
					...
					<li><a
						href="<?php echo sfConfig::get('app_notification_bot_url'); ?>/download/rayku.exe"
						class="icon windows">Windows Software</a></li>
					<li><a
						href="<?php echo sfConfig::get('app_notification_bot_url'); ?>/download/rayku.dmg"
						class="icon mac">MacOS Software</a></li>
				</ul>
				<div class="clear"></div>
			</div>
			<!--widget main-->
