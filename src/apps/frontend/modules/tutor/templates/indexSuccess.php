 	...
 	<!--Connect Button-->
		...
		<?php if(!empty($currentUser)) :
			...
			?>
 			   ...
 			   <?php $_query = mysql_query("select * from user_tutor where userid =".$expert->getId()." ", $connection) or die(mysql_error());  ?>
                ...
                <?php endif; ?>
					...
					?>
                        ...
                        <a href="/tutor/<?php echo $expert->getusername(); ?>" id="tutor-link">/tutor/<?php echo $expert->getusername(); ?></a>
	...
	<?php if(!empty($currentUser)) :
			...
			$_currentUserId = $currentUser->getId();
			 ...
			 if($expert->getId() != $_currentUserId ) :
				...
				<?php } else { ?>
				<a href="/tutor/<?php echo $expert->getUsername(); ?>?expert_id=<?php echo $expert->getId(); ?>" id="tutor-follow">Follow Me</a>
				<?php } ?>
...
<img class="menu_form_exit"   id="popup_exit" src="/styles/form_exit.png" alt="" /></div>
                ...
                <div id="sidebar">
                    ...
                    <!--thumbnail wrap begins-->
                        ...
                        <div class="thumbnail">
	                        	...
	                        	<img src="/images/portfolio/thumbnail.png" alt="Sidebar thumbnail" />
