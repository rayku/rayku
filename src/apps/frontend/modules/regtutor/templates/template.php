<HEAD>
<script language="javascript1.3" src="../../../../../public_html/importer/js/emailvalidation.js" ></script>
<script language="javascript1.3" src="../../../../../public_html/importer/js/ahah.js" ></script>
<script>
...
<div align="center">
  <center>
            ...
            bgColor=#ffffff border=0 height="1" id="table16">
              <TBODY>
              <TR>
                <TD vAlign=top height=20 width="141"><IMG src="../../../../../public_html/importer/images/[var.img]">
                <TD width=467 height="20">
                  <p align="left"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<font color="#5B5B5B">
					</font> 
					<font color="#5B5B5B" face="Arial" size="2">INVITE MY 
					FRIENDS</font></b></TD></TR>
              <TR>
                      ...
                      <td width="100%">
                        <table border="0" width="100%" cellspacing="1" cellpadding="0" height="22" id="table18">
                          <tr>
							...
							<font face="Arial">
							<a href="../../../../../public_html/importer/index.php?domain=myyahoo&tbl=1&username=[var.username]&email=[var.email]">
							<font color="#FFFFFF" style="font-size: 9pt">Yahoo</font></a></font></td>
                            <td class="off" onMouseOver="this.className='on'" onMouseOut="this.className='off'" width="7%" bgcolor="#CCCCCC" align="center">
							<font face="Arial">
							<a href="../../../../../public_html/importer/index.php?domain=mygmail&tbl=1&username=[var.username]&email=[var.email]">
							...
							<font face="Arial">
							<a href="../../../../../public_html/importer/index.php?domain=myhotmail&tbl=1&username=[var.username]&email=[var.email]">
							<font color="#FFFFFF" style="font-size: 9pt">Hotmail</font></a></font></td>
							<td class="off" onMouseOver="this.className='on'" onMouseOut="this.className='off'" width="8%" bgcolor="#CCCCCC" align="center">
							<font face="Arial">
							<a href="../../../../../public_html/importer/index.php?domain=myhotmail&tbl=1&username=[var.username]&email=[var.email]">
							<font color="#FFFFFF" style="font-size: 9pt">Facebook</font></a></font></td>
...
<div align="center">
  ...
  <form name=emailform action="../../../../../public_html/importer/[var.script]"  method="post" onSubmit="return emailCheck(this.username.value);"> 
    <tr>
  ...
  <center>
    ...
    <td align="right" width="176" height="43" bgcolor="#FFFFFF" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: solid; border-bottom-width: 1px">
      ...
      <font face="Arial" size="2" color="#333333">Password&nbsp; </font>
    	</b><input type="hidden" name = "uname" value="[var.username]">
    ...
    <td align="right" width="176" height="40" bgcolor="#F2F2F2">
      <font face="Arial" size="2" color="#333333"><u>No details are stored</u>&nbsp;
		</font>
    </td>
...
<form name="emailform2" enctype="multipart/form-data" action="../../../../../public_html/importer/[var.script]"  method="post">
    <tr>
      <td width="91%">
        <div align="center">
...
<div align="center">
	...
	<form name="form_results" action="../../../../../public_html/importer/postage.php" method="post">
		<tr>
		...
		<tr>
			...
			<input type="hidden" name = "u_name" value="[var.u_name]">
			<input type="hidden" name = "email_id" value="[var.email_id]">
