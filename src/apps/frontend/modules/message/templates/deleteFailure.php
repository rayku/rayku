<div class="body-main">
  ...
  <div style="font-size:16px;padding:10px;"> ERROR. Please try again. <?php echo link_to('Back to private messages', '@inbox',array('style'=>'color:#069;font-weight:bold')); ?>.</div>
</div>
