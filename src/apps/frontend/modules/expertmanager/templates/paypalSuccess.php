...
{
	 	cre_amount = document.getElementById('amount').value; 
		
		var temp1 = document.getElementById('return');
		var url = 'http://<?php echo RaykuCommon::getCurrentHttpDomain();?>/expertmanager/confirmation' + '/e_id/' + <?php echo $expert_id;?> + '/l_id/' +<?php echo $expert_lesson_id; ?> + '/amt/' + cre_amount ; 
		...
		<div class="top"></div>
			<div class="content">
				<div class="entry">
					...
					<div>
						<input type=text size=4 maxlength=7 name="amount" id="amount" value="" onchange="return generateamount();"> 
				...
				<div class="entry">
					<div class="ttle">Enter paypal id:</div>
					<div>
						<input type="text" name="paypalId" id="paypalId" value=""/>
						<div class="information">
