<script type="text/javascript" src="http://<?php echo RaykuCommon::getCurrentHttpDomain();?>/js/tabcontent.js">	
</script>
...
<div class="body-main">
		...
		<h1 class="cal">Select your convinient date:</h1>
		<h3 class="leg"><span>White = free</span> <span>Blue = booked</span></h3>
		<div class="clear-both"></div>
		
		<?php echo form_tag('expertmanager/studentreschedule'); ?>
		...
		<?php
								...
								echo $cal->getMonthHTML($next_1,$y,0,$scheduled_current_days);
								
								echo $cal->getMonthHTML($next_2,$y,0,$scheduled_current_days);
		...
		?>
				...
				<div id="schedule"></div>		
						...
						<h3>Select days:</h3>
							...
							<input type="checkbox" name="days[]" value="mon" /><label>Every Monday</label>
							<input type="checkbox" name="days[]" value="tue"  /><label>Every Tuesday</label>
							<input type="checkbox" name="days[]" value="wed" /><label>Every Wednesday</label>
							<input type="checkbox" name="days[]" value="thur"  /><label>Every Thursday</label>
							<input type="checkbox" name="days[]" value="fri"  /><label>Every Friday</label>
						</div>
				
				
			 <input class="blue1" type="submit" name="commit" value="Send PM to expert" />
