...
<div class="body-main">
		...
		<div class="left-bg">
			<div class="left-top"></div>
				<label style="font-size:12px; color:#1C517C; margin-left:30px;"  ><?php echo $lesson->getContent(); ?></label>
			<div class="left-bottom"></div>
		</div>
		
		<!--<h1 class="cal">Sceduled time of lesson:</h1>
		...
		<div class="clear-both"></div>
			...
			<?php // if( $expert_lesson->getDay() != NULL ): ?>
...
<div class="body-side">
	...
	<?php echo link_to('Reschedule this lesson', 'expertmanager/reschedule?less_id='.$less_id.'',array('class' => 'navlink next')); ?>
	
	<?php echo link_to('Click here to cancel this class', 'expertmanager/cancel?less_id='.$less_id.'',array('class' => 'navlink next')); ?>
