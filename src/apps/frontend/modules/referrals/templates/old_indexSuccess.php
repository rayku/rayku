...
if($user_id)
{
	...
	echo '
<br/>
Use this link with friends: <input type="text" id="global-referral-link" class="textinput" value="'.sfConfig::get('app_rayku_url').'/register?ref='.$user_id.'" size="100"><br/>
';
...
<textarea rows=4 cols=60 id="share_desc">Free online tutoring with @rayku ! Get it here: '.sfConfig::get('app_rayku_url').'/register?ref='.$user_id.'</textarea>
<br/>
<!-- <a href="https://twitter.com/share" class="twitter-share-button" data-url="'.sfConfig::get('app_rayku_url').'/register?ref='.$user_id.'" data-via="rayku" data-lang="en" >Tweet</a> -->
...
function tweet()
{
	u="'.sfConfig::get('app_rayku_url').'/register?ref='.$user_id.'";
...
function fbs_click() {u="'.sfConfig::get('app_rayku_url').'/register?ref='.$user_id.'";t=document.title;window.open(\'http://www.facebook.com/sharer.php?u=\'+encodeURIComponent(u)+\'&t=\'+encodeURIComponent(t),\'sharer\',\'toolbar=0,status=0,width=626,height=436\');return false;}
