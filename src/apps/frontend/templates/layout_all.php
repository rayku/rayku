...
<link rel="stylesheet" type="text/css" href="<?php echo $baseRootPath; ?>/css/custom/gallery-homepage.css"/>
<?php endif; ?>
<?php if($sf_context->getModuleName() =='gallery' and $sf_context->getActionName() =='show'): ?>
<link rel="stylesheet" type="text/css" href="<?php echo $baseRootPath; ?>/css/custom/album-homepage.css"/>
<?php endif; ?>
<?php if($sf_context->getModuleName() =='gallery' and $sf_context->getActionName() =='upload'): ?>
<link rel="stylesheet" type="text/css" href="<?php echo $baseRootPath; ?>/css/custom/upload-media.css"/>
<?php endif; ?>
<?php if($sf_context->getModuleName() =='gallery'): ?>
<link rel="stylesheet" type="text/css" href="<?php echo $baseRootPath; ?>/css/custom/view-media.css"/>
<?php endif; ?>
