...
<h1>All threads so far posted</h1>
...
$tbl_name = "thread"; $adjacents = 1;
	...
	$sql = "SELECT * FROM $tbl_name ORDER BY created_at DESC LIMIT $start, $limit";
...
$row = $i%2 ; ?>
	...
	<tr class="sf_admin_row_<?=$row?>">
     ...
     <td><?php echo ($_row['user_ip']); ?></td>
      <td><?php echo $_row['date']; ?></td>
      <td><?php echo $_row['banned']; ?></td>
