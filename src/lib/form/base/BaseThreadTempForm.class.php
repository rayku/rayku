...
/**
 * ThreadTemp form base class.
 *
 * @package    elifes
 * @subpackage form
 * @author     Your name here
 */
class BaseThreadTempForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'           => new sfValidatorPropelChoice(array('model' => 'ThreadTemp', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('thread_temp[%s]');
