...
abstract class BaseForumPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Forum';
	...
	const TYPE = 'forum.TYPE';

	/** the column name for the ENTITY_ID field */
	const ENTITY_ID = 'forum.ENTITY_ID';

	/** the column name for the TOP_OR_BOTTOM field */
	const TOP_OR_BOTTOM = 'forum.TOP_OR_BOTTOM';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'Type', 'EntityId', 'TopOrBottom', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'type', 'entityId', 'topOrBottom', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DESCRIPTION, self::TYPE, self::ENTITY_ID, self::TOP_OR_BOTTOM, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'type', 'entity_id', 'top_or_bottom', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'Type' => 3, 'EntityId' => 4, 'TopOrBottom' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'type' => 3, 'entityId' => 4, 'topOrBottom' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::TYPE => 3, self::ENTITY_ID => 4, self::TOP_OR_BOTTOM => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'type' => 3, 'entity_id' => 4, 'top_or_bottom' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ForumMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ForumPeer::NAME);

		$criteria->addSelectColumn(ForumPeer::DESCRIPTION);

		$criteria->addSelectColumn(ForumPeer::TYPE);

		$criteria->addSelectColumn(ForumPeer::ENTITY_ID);

		$criteria->addSelectColumn(ForumPeer::TOP_OR_BOTTOM);
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return ForumPeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a Forum or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Forum or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ForumPeer::ID, $criteria->remove(ForumPeer::ID), $comparison);
	...
	/**
	 * Method to DELETE all rows from the forum table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ForumPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Forum or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Forum) {
	 ...
	 */
	public static function doValidate(Forum $obj, $cols = null)
	{
		$columns = array();
		...
		$res =  BasePeer::doValidate(ForumPeer::DATABASE_NAME, ForumPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = ForumPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the ForumPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ForumPeer class:
//
// Propel::getDatabaseMap(ForumPeer::DATABASE_NAME)->addTableBuilder(ForumPeer::TABLE_NAME, ForumPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseForumPeer::DATABASE_NAME)->addTableBuilder(BaseForumPeer::TABLE_NAME, BaseForumPeer::getMapBuilder());
