...
abstract class BaseWhiteboardConnection extends BaseObject  implements Persistent {
  ...
  const PEER = 'WhiteboardConnectionPeer';
	...
	public function ensureConsistency()
	{
		...
		if ($this->aStudentQuestion !== null && $this->question_id !== $this->aStudentQuestion->getId()) {
			$this->aStudentQuestion = null;
		}
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aStudentQuestion !== null) {
				if ($this->aStudentQuestion->isModified() || $this->aStudentQuestion->isNew()) {
					$affectedRows += $this->aStudentQuestion->save($con);
				}
				$this->setStudentQuestion($this->aStudentQuestion);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aStudentQuestion !== null) {
				if (!$this->aStudentQuestion->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aStudentQuestion->getValidationFailures());
				}
			}
