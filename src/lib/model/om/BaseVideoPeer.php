...
abstract class BaseVideoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'OwnerId', 'Name', 'Description', 'Type', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'ownerId', 'name', 'description', 'type', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::OWNER_ID, self::NAME, self::DESCRIPTION, self::TYPE, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'owner_id', 'name', 'description', 'type', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'OwnerId' => 1, 'Name' => 2, 'Description' => 3, 'Type' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'ownerId' => 1, 'name' => 2, 'description' => 3, 'type' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::OWNER_ID => 1, self::NAME => 2, self::DESCRIPTION => 3, self::TYPE => 4, self::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'owner_id' => 1, 'name' => 2, 'description' => 3, 'type' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VideoPeer::OWNER_ID);
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doValidate(Video $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(VideoPeer::DATABASE_NAME, VideoPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = VideoPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
