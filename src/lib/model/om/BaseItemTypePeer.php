...
abstract class BaseItemTypePeer {
	...
	const NAME = 'item_type.NAME';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'item_type.CREATED_AT';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ItemTypeMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ItemTypePeer::CREATED_AT);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a ItemType or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ItemTypePeer::ID) && $criteria->keyContainsValue(ItemTypePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ItemTypePeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ItemType or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the item_type table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ItemType or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ItemType) {
...
//
// NOTE: This static code cannot call methods on the ItemTypePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ItemTypePeer class:
//
// Propel::getDatabaseMap(ItemTypePeer::DATABASE_NAME)->addTableBuilder(ItemTypePeer::TABLE_NAME, ItemTypePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseItemTypePeer::DATABASE_NAME)->addTableBuilder(BaseItemTypePeer::TABLE_NAME, BaseItemTypePeer::getMapBuilder());
