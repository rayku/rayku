...
abstract class BaseVideo extends BaseObject  implements Persistent {
  ...
  const PEER = 'VideoPeer';
	...
	public function setOwnerId($v)
	{
		...
		if ($this->owner_id !== $v) {
			$this->owner_id = $v;
			$this->modifiedColumns[] = VideoPeer::OWNER_ID;
		}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(VideoPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::OWNER_ID)) $criteria->add(VideoPeer::OWNER_ID, $this->owner_id);
