...
abstract class BaseUserPeer {
	...
	/** the column name for the WWW_ONLINE_STATUS field */
	const WWW_ONLINE_STATUS = 'user.WWW_ONLINE_STATUS';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::WWW_ONLINE_STATUS);
