	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in OfferVoucherPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			OfferVoucherPeer::clearInstancePool();

			// invalidate objects in PostPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
