...
abstract class BaseItemType extends BaseObject  implements Persistent {
  ...
  const PEER = 'ItemTypePeer';
	...
	/**
	 * Initializes internal state of BaseItemType object.
	 * @see        applyDefaults()
	 */
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ItemTypePeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ItemTypePeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ItemTypePeer::NUM_COLUMNS - ItemTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			ItemTypePeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(ItemTypePeer::CREATED_AT))
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ItemTypePeer::doInsert($this, $con);
					...
					$affectedRows += ItemTypePeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ItemTypePeer::NAME)) $criteria->add(ItemTypePeer::NAME, $this->name);
		if ($this->isColumnModified(ItemTypePeer::CREATED_AT)) $criteria->add(ItemTypePeer::CREATED_AT, $this->created_at);
	 ...
	 * Otherwise if this ItemType has previously been saved, it will retrieve
	 * related Items from storage. If this ItemType is new, it will return
		...
		if ($this->collItems === null) {
			if ($this->isNew()) {
			   $this->collItems = array();
				...
				$criteria->add(ItemPeer::ITEM_TYPE_ID, $this->id);
	 ...
	 */
	public function getItemsJoinSize($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ItemTypePeer::DATABASE_NAME);
		}
		...
		if ($this->collItems === null) {
			if ($this->isNew()) {
				...
				$this->collItems = ItemPeer::doSelectJoinSize($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
