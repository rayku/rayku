...
abstract class BasePostPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new PostMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PostPeer::POSTER_ID);
...
//
// NOTE: This static code cannot call methods on the PostPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PostPeer class:
//
// Propel::getDatabaseMap(PostPeer::DATABASE_NAME)->addTableBuilder(PostPeer::TABLE_NAME, PostPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BasePostPeer::DATABASE_NAME)->addTableBuilder(BasePostPeer::TABLE_NAME, BasePostPeer::getMapBuilder());
