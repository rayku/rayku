...
abstract class BasePost extends BaseObject  implements Persistent {
  ...
  const PEER = 'PostPeer';
	...
	public function setPosterId($v)
	{
		...
		if ($this->poster_id !== $v) {
			$this->poster_id = $v;
			$this->modifiedColumns[] = PostPeer::POSTER_ID;
		}
	...
	public function setBestResponse($v)
	{
		...
		if ($this->best_response !== $v) {
			$this->best_response = $v;
			$this->modifiedColumns[] = PostPeer::BEST_RESPONSE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PostPeer::POSTER_ID)) $criteria->add(PostPeer::POSTER_ID, $this->poster_id);
