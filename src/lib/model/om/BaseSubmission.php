...
abstract class BaseSubmission extends BaseObject  implements Persistent {
  ...
  const PEER = 'SubmissionPeer';
	...
	/**
	 * Initializes internal state of BaseSubmission object.
	 * @see        applyDefaults()
	 */
	...
	public function setAssignmentId($v)
	{
		...
		if ($this->assignment_id !== $v) {
			...
			$this->modifiedColumns[] = SubmissionPeer::ASSIGNMENT_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = SubmissionPeer::USER_ID;
		}
	...
	public function setData($v)
	{
		...
		if ($this->data !== $v) {
			$this->data = $v;
			$this->modifiedColumns[] = SubmissionPeer::DATA;
		}
	...
	public function setGrade($v)
	{
		...
		if ($this->grade !== $v || $v === 'null') {
			$this->grade = $v;
			$this->modifiedColumns[] = SubmissionPeer::GRADE;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = SubmissionPeer::COMMENT;
		}
	...
	public function setApproved($v)
	{
		...
		if ($this->approved !== $v || $v === 0) {
			$this->approved = $v;
			$this->modifiedColumns[] = SubmissionPeer::APPROVED;
		}
	...
	public function setPath($v)
	{
		...
		if ($this->path !== $v) {
			$this->path = $v;
			$this->modifiedColumns[] = SubmissionPeer::PATH;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SubmissionPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SubmissionPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SubmissionPeer::GRADE,SubmissionPeer::APPROVED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->assignment_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->user_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->data = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->grade = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 10; // 10 = SubmissionPeer::NUM_COLUMNS - SubmissionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	{
    if ($this->isNew() && !$this->isColumnModified(SubmissionPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(SubmissionPeer::UPDATED_AT))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setAssignmentId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SubmissionPeer::ASSIGNMENT_ID)) $criteria->add(SubmissionPeer::ASSIGNMENT_ID, $this->assignment_id);
		if ($this->isColumnModified(SubmissionPeer::USER_ID)) $criteria->add(SubmissionPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(SubmissionPeer::DATA)) $criteria->add(SubmissionPeer::DATA, $this->data);
		if ($this->isColumnModified(SubmissionPeer::GRADE)) $criteria->add(SubmissionPeer::GRADE, $this->grade);
		if ($this->isColumnModified(SubmissionPeer::COMMENT)) $criteria->add(SubmissionPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(SubmissionPeer::APPROVED)) $criteria->add(SubmissionPeer::APPROVED, $this->approved);
		if ($this->isColumnModified(SubmissionPeer::PATH)) $criteria->add(SubmissionPeer::PATH, $this->path);
		if ($this->isColumnModified(SubmissionPeer::CREATED_AT)) $criteria->add(SubmissionPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(SubmissionPeer::UPDATED_AT)) $criteria->add(SubmissionPeer::UPDATED_AT, $this->updated_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAssignmentId($this->assignment_id);
	 ...
	 * @throws     PropelException
	 */
	public function getAssignment(PropelPDO $con = null)
	{
		if ($this->aAssignment === null && ($this->assignment_id !== null)) {
			$c = new Criteria(AssignmentPeer::DATABASE_NAME);
			$c->add(AssignmentPeer::ID, $this->assignment_id);
			$this->aAssignment = AssignmentPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAssignment->addSubmissions($this);
			 */
		}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUser->addSubmissions($this);
			 */
		}
		return $this->aUser;
	}
