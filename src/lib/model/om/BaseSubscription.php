  ...
  const PEER = 'SubscriptionPeer';
	...
	public function setNotificationType($v)
	{
		...
		if ($this->notification_type !== $v) {
			...
			$this->modifiedColumns[] = SubscriptionPeer::NOTIFICATION_TYPE;
		}
	...
	public function setTeacherId($v)
	{
		...
		if ($this->teacher_id !== $v) {
			$this->teacher_id = $v;
			$this->modifiedColumns[] = SubscriptionPeer::TEACHER_ID;
		}
	...
	public function setClassroomId($v)
	{
		...
		if ($this->classroom_id !== $v) {
			$this->classroom_id = $v;
			$this->modifiedColumns[] = SubscriptionPeer::CLASSROOM_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->notification_type = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->user_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->teacher_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->classroom_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = SubscriptionPeer::NUM_COLUMNS - SubscriptionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setTeacherId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setClassroomId($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SubscriptionPeer::NOTIFICATION_TYPE)) $criteria->add(SubscriptionPeer::NOTIFICATION_TYPE, $this->notification_type);
		if ($this->isColumnModified(SubscriptionPeer::USER_ID)) $criteria->add(SubscriptionPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(SubscriptionPeer::TEACHER_ID)) $criteria->add(SubscriptionPeer::TEACHER_ID, $this->teacher_id);
		if ($this->isColumnModified(SubscriptionPeer::CLASSROOM_ID)) $criteria->add(SubscriptionPeer::CLASSROOM_ID, $this->classroom_id);
