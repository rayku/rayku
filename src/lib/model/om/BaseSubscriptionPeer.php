...
abstract class BaseSubscriptionPeer {
	...
	const NOTIFICATION_TYPE = 'subscription.NOTIFICATION_TYPE';

	/** the column name for the USER_ID field */
	const USER_ID = 'subscription.USER_ID';

	/** the column name for the TEACHER_ID field */
	const TEACHER_ID = 'subscription.TEACHER_ID';

	/** the column name for the CLASSROOM_ID field */
	const CLASSROOM_ID = 'subscription.CLASSROOM_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'NotificationType', 'UserId', 'TeacherId', 'ClassroomId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'notificationType', 'userId', 'teacherId', 'classroomId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOTIFICATION_TYPE, self::USER_ID, self::TEACHER_ID, self::CLASSROOM_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'notification_type', 'user_id', 'teacher_id', 'classroom_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NotificationType' => 1, 'UserId' => 2, 'TeacherId' => 3, 'ClassroomId' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'notificationType' => 1, 'userId' => 2, 'teacherId' => 3, 'classroomId' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOTIFICATION_TYPE => 1, self::USER_ID => 2, self::TEACHER_ID => 3, self::CLASSROOM_ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'notification_type' => 1, 'user_id' => 2, 'teacher_id' => 3, 'classroom_id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SubscriptionMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubscriptionPeer::NOTIFICATION_TYPE);

		$criteria->addSelectColumn(SubscriptionPeer::USER_ID);

		$criteria->addSelectColumn(SubscriptionPeer::TEACHER_ID);

		$criteria->addSelectColumn(SubscriptionPeer::CLASSROOM_ID);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(SubscriptionPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Subscription) {
...
//
// NOTE: This static code cannot call methods on the SubscriptionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SubscriptionPeer class:
//
// Propel::getDatabaseMap(SubscriptionPeer::DATABASE_NAME)->addTableBuilder(SubscriptionPeer::TABLE_NAME, SubscriptionPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSubscriptionPeer::DATABASE_NAME)->addTableBuilder(BaseSubscriptionPeer::TABLE_NAME, BaseSubscriptionPeer::getMapBuilder());
