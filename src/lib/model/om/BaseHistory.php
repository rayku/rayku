...
abstract class BaseHistory extends BaseObject  implements Persistent {
  ...
  const PEER = 'HistoryPeer';
	...
	/**
	 * The value for the entity_type field.
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseHistory object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [entity_type] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [entity_type] column.
	 * 
	...
	public function setEntityType($v)
	{
		...
		if ($this->entity_type !== $v) {
			$this->entity_type = $v;
			$this->modifiedColumns[] = HistoryPeer::ENTITY_TYPE;
		}
	...
	public function setData($v)
	{
		...
		if ($this->data !== $v) {
			$this->data = $v;
			$this->modifiedColumns[] = HistoryPeer::DATA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->entity_type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = HistoryPeer::NUM_COLUMNS - HistoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(HistoryPeer::ENTITY_TYPE)) $criteria->add(HistoryPeer::ENTITY_TYPE, $this->entity_type);
		if ($this->isColumnModified(HistoryPeer::DATA)) $criteria->add(HistoryPeer::DATA, $this->data);
