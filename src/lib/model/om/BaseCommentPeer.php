...
abstract class BaseCommentPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CommentMapBuilder();
		}
...
//
// NOTE: This static code cannot call methods on the CommentPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CommentPeer class:
//
// Propel::getDatabaseMap(CommentPeer::DATABASE_NAME)->addTableBuilder(CommentPeer::TABLE_NAME, CommentPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseCommentPeer::DATABASE_NAME)->addTableBuilder(BaseCommentPeer::TABLE_NAME, BaseCommentPeer::getMapBuilder());
