  ...
  const PEER = 'PicturePeer';
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PicturePeer::DESCRIPTION;
		}
	...
	public function setOwnerId($v)
	{
		...
		if ($this->owner_id !== $v) {
			$this->owner_id = $v;
			$this->modifiedColumns[] = PicturePeer::OWNER_ID;
		}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(PicturePeer::CREATED_AT))
    {
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->owner_id !== null)) {
			...
			$c->add(UserPeer::ID, $this->owner_id);
	 ...
	 * related Users from storage. If this Picture is new, it will return
