...
/**
 * Base class that represents a row from the 'journal_entry' table.
 *
 * 
 *
...
abstract class BaseJournalEntry extends BaseObject  implements Persistent {
  ...
  const PEER = 'JournalEntryPeer';
	...
	/**
	 * The value for the show_entity field.
	 * @var        int
	 */
	protected $show_entity;
	...
	/**
	 * Get the [show_entity] column value.
	 * 
	 * @return     int
	 */
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = JournalEntryPeer::USER_ID;
		}
	...
	public function setSubject($v)
	{
		...
		if ($this->subject !== $v) {
			$this->subject = $v;
			$this->modifiedColumns[] = JournalEntryPeer::SUBJECT;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = JournalEntryPeer::CONTENT;
		}
	...
	/**
	 * Set the value of [show_entity] column.
	 * 
	 * @param      int $v new value
	 * @return     JournalEntry The current object (for fluent API support)
	 */
	public function setShowEntity($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->show_entity !== $v) {
			$this->show_entity = $v;
			$this->modifiedColumns[] = JournalEntryPeer::SHOW_ENTITY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->show_entity = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = JournalEntryPeer::NUM_COLUMNS - JournalEntryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			JournalEntryPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(JournalEntryPeer::CREATED_AT))
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = JournalEntryPeer::doInsert($this, $con);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setShowEntity($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JournalEntryPeer::USER_ID)) $criteria->add(JournalEntryPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(JournalEntryPeer::SUBJECT)) $criteria->add(JournalEntryPeer::SUBJECT, $this->subject);
		if ($this->isColumnModified(JournalEntryPeer::CONTENT)) $criteria->add(JournalEntryPeer::CONTENT, $this->content);
		if ($this->isColumnModified(JournalEntryPeer::CREATED_AT)) $criteria->add(JournalEntryPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(JournalEntryPeer::SHOW_ENTITY)) $criteria->add(JournalEntryPeer::SHOW_ENTITY, $this->show_entity);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setShowEntity($this->show_entity);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addJournalEntrys($this);
			 */
		}
		return $this->aUser;
	}
	 ...
	 * Otherwise if this JournalEntry has previously been saved, it will retrieve
	 * related Comments from storage. If this JournalEntry is new, it will return
		...
		if ($this->collComments === null) {
			if ($this->isNew()) {
			   $this->collComments = array();
				...
				$criteria->add(CommentPeer::JOURNAL_ENTRY_ID, $this->id);
