...
/**
 * Base static class for performing query and update operations on the 'journal_entry' table.
 *
 * 
 *
...
abstract class BaseJournalEntryPeer {
	...
	const TABLE_NAME = 'journal_entry';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.JournalEntry';
	...
	const ID = 'journal_entry.ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'journal_entry.USER_ID';

	/** the column name for the SUBJECT field */
	const SUBJECT = 'journal_entry.SUBJECT';

	/** the column name for the CONTENT field */
	const CONTENT = 'journal_entry.CONTENT';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'journal_entry.CREATED_AT';

	/** the column name for the SHOW_ENTITY field */
	const SHOW_ENTITY = 'journal_entry.SHOW_ENTITY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Subject', 'Content', 'CreatedAt', 'ShowEntity', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'subject', 'content', 'createdAt', 'showEntity', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::SUBJECT, self::CONTENT, self::CREATED_AT, self::SHOW_ENTITY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'subject', 'content', 'created_at', 'show_entity', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Subject' => 2, 'Content' => 3, 'CreatedAt' => 4, 'ShowEntity' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'subject' => 2, 'content' => 3, 'createdAt' => 4, 'showEntity' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::SUBJECT => 2, self::CONTENT => 3, self::CREATED_AT => 4, self::SHOW_ENTITY => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'subject' => 2, 'content' => 3, 'created_at' => 4, 'show_entity' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new JournalEntryMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(JournalEntryPeer::USER_ID);

		$criteria->addSelectColumn(JournalEntryPeer::SUBJECT);

		$criteria->addSelectColumn(JournalEntryPeer::CONTENT);

		$criteria->addSelectColumn(JournalEntryPeer::CREATED_AT);

		$criteria->addSelectColumn(JournalEntryPeer::SHOW_ENTITY);
	 ...
	 *
	 * @param      JournalEntry $value A JournalEntry object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(JournalEntry $obj, $key = null)
	{
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(JournalEntryPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (JournalEntryPeer::NUM_COLUMNS - JournalEntryPeer::NUM_LAZY_LOAD_COLUMNS);
		UserPeer::addSelectColumns($c);

		$c->addJoin(array(JournalEntryPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		JournalEntryPeer::addSelectColumns($c);
		$startcol2 = (JournalEntryPeer::NUM_COLUMNS - JournalEntryPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return JournalEntryPeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a JournalEntry or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a JournalEntry or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(JournalEntryPeer::ID, $criteria->remove(JournalEntryPeer::ID), $comparison);
	...
	/**
	 * Method to DELETE all rows from the journal_entry table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(JournalEntryPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a JournalEntry or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(JournalEntry $obj, $cols = null)
	{
		$columns = array();
		...
		$res =  BasePeer::doValidate(JournalEntryPeer::DATABASE_NAME, JournalEntryPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = JournalEntryPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the JournalEntryPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the JournalEntryPeer class:
//
// Propel::getDatabaseMap(JournalEntryPeer::DATABASE_NAME)->addTableBuilder(JournalEntryPeer::TABLE_NAME, JournalEntryPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseJournalEntryPeer::DATABASE_NAME)->addTableBuilder(BaseJournalEntryPeer::TABLE_NAME, BaseJournalEntryPeer::getMapBuilder());
