...
/**
 * Base class that represents a row from the 'thread_temp' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseThreadTemp extends BaseObject  implements Persistent {


  const PEER = 'ThreadTempPeer';
	...
	/**
	 * Initializes internal state of BaseThreadTemp object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ThreadTemp The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ThreadTempPeer::ID;
		}
	...
	public function setPosterId($v)
	{
		...
		if ($this->poster_id !== $v) {
			$this->poster_id = $v;
			$this->modifiedColumns[] = ThreadTempPeer::POSTER_ID;
		}
	...
	public function setForumId($v)
	{
		...
		if ($this->forum_id !== $v) {
			$this->forum_id = $v;
			$this->modifiedColumns[] = ThreadTempPeer::FORUM_ID;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = ThreadTempPeer::TITLE;
		}
	...
	public function setTags($v)
	{
		...
		if ($this->tags !== $v) {
			$this->tags = $v;
			$this->modifiedColumns[] = ThreadTempPeer::TAGS;
		}
	...
	public function setVisible($v)
	{
		...
		if ($this->visible !== $v) {
			$this->visible = $v;
			$this->modifiedColumns[] = ThreadTempPeer::VISIBLE;
		}
	...
	public function setCancel($v)
	{
		...
		if ($this->cancel !== $v) {
			$this->cancel = $v;
			$this->modifiedColumns[] = ThreadTempPeer::CANCEL;
		}
	...
	public function setCategoryId($v)
	{
		...
		if ($this->category_id !== $v) {
			$this->category_id = $v;
			$this->modifiedColumns[] = ThreadTempPeer::CATEGORY_ID;
		}
	...
	public function setNotifyEmail($v)
	{
		...
		if ($this->notify_email !== $v) {
			$this->notify_email = $v;
			$this->modifiedColumns[] = ThreadTempPeer::NOTIFY_EMAIL;
		}
	...
	public function setNotifyPm($v)
	{
		...
		if ($this->notify_pm !== $v) {
			$this->notify_pm = $v;
			$this->modifiedColumns[] = ThreadTempPeer::NOTIFY_PM;
		}
	...
	public function setNotifySms($v)
	{
		...
		if ($this->notify_sms !== $v) {
			$this->notify_sms = $v;
			$this->modifiedColumns[] = ThreadTempPeer::NOTIFY_SMS;
		}
	...
	public function setCellNumber($v)
	{
		...
		if ($this->cell_number !== $v) {
			$this->cell_number = $v;
			$this->modifiedColumns[] = ThreadTempPeer::CELL_NUMBER;
		}
	...
	public function setSchoolGrade($v)
	{
		...
		if ($this->school_grade !== $v) {
			$this->school_grade = $v;
			$this->modifiedColumns[] = ThreadTempPeer::SCHOOL_GRADE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ThreadTempPeer::CREATED_AT;
			}
	...
	public function setLastpostAt($v)
	{
		...
		if ( $this->lastpost_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ThreadTempPeer::LASTPOST_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 15; // 15 = ThreadTempPeer::NUM_COLUMNS - ThreadTempPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ThreadTemp object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ThreadTempPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			ThreadTempPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(ThreadTempPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
			ThreadTempPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ThreadTempPeer::doInsert($this, $con);
					...
					$affectedRows += ThreadTempPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ThreadTempPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ThreadTempPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ThreadTempPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ThreadTempPeer::ID)) $criteria->add(ThreadTempPeer::ID, $this->id);
		if ($this->isColumnModified(ThreadTempPeer::POSTER_ID)) $criteria->add(ThreadTempPeer::POSTER_ID, $this->poster_id);
		if ($this->isColumnModified(ThreadTempPeer::FORUM_ID)) $criteria->add(ThreadTempPeer::FORUM_ID, $this->forum_id);
		if ($this->isColumnModified(ThreadTempPeer::TITLE)) $criteria->add(ThreadTempPeer::TITLE, $this->title);
		if ($this->isColumnModified(ThreadTempPeer::TAGS)) $criteria->add(ThreadTempPeer::TAGS, $this->tags);
		if ($this->isColumnModified(ThreadTempPeer::VISIBLE)) $criteria->add(ThreadTempPeer::VISIBLE, $this->visible);
		if ($this->isColumnModified(ThreadTempPeer::CANCEL)) $criteria->add(ThreadTempPeer::CANCEL, $this->cancel);
		if ($this->isColumnModified(ThreadTempPeer::CATEGORY_ID)) $criteria->add(ThreadTempPeer::CATEGORY_ID, $this->category_id);
		if ($this->isColumnModified(ThreadTempPeer::NOTIFY_EMAIL)) $criteria->add(ThreadTempPeer::NOTIFY_EMAIL, $this->notify_email);
		if ($this->isColumnModified(ThreadTempPeer::NOTIFY_PM)) $criteria->add(ThreadTempPeer::NOTIFY_PM, $this->notify_pm);
		if ($this->isColumnModified(ThreadTempPeer::NOTIFY_SMS)) $criteria->add(ThreadTempPeer::NOTIFY_SMS, $this->notify_sms);
		if ($this->isColumnModified(ThreadTempPeer::CELL_NUMBER)) $criteria->add(ThreadTempPeer::CELL_NUMBER, $this->cell_number);
		if ($this->isColumnModified(ThreadTempPeer::SCHOOL_GRADE)) $criteria->add(ThreadTempPeer::SCHOOL_GRADE, $this->school_grade);
		if ($this->isColumnModified(ThreadTempPeer::CREATED_AT)) $criteria->add(ThreadTempPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(ThreadTempPeer::LASTPOST_AT)) $criteria->add(ThreadTempPeer::LASTPOST_AT, $this->lastpost_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ThreadTempPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ThreadTemp (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ThreadTemp Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ThreadTempPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ThreadTempPeer();
		}
		return self::$peer;
	}
