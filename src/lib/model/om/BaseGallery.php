  ...
  const PEER = 'GalleryPeer';
	...
	public function setShowEntity($v)
	{
		...
		if ($this->show_entity !== $v) {
			$this->show_entity = $v;
			$this->modifiedColumns[] = GalleryPeer::SHOW_ENTITY;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = GalleryPeer::USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->show_entity = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 7; // 7 = GalleryPeer::NUM_COLUMNS - GalleryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setShowEntity($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GalleryPeer::SHOW_ENTITY)) $criteria->add(GalleryPeer::SHOW_ENTITY, $this->show_entity);
		if ($this->isColumnModified(GalleryPeer::USER_ID)) $criteria->add(GalleryPeer::USER_ID, $this->user_id);
		...
		if ($this->isColumnModified(GalleryPeer::CLASSROOM_ID)) $criteria->add(GalleryPeer::CLASSROOM_ID, $this->classroom_id);
	 ...
	 * Otherwise if this Gallery has previously been saved, it will retrieve
	 * related GalleryItems from storage. If this Gallery is new, it will return
		...
		if ($this->collGalleryItems === null) {
			if ($this->isNew()) {
			   $this->collGalleryItems = array();
				...
				$criteria->add(GalleryItemPeer::GALLERY_ID, $this->id);
	 ...
	 * Otherwise if this Gallery is new, it will return
	 * an empty collection; or if this Gallery has previously
	 * been saved, it will retrieve related GalleryItems from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Gallery.
	 */
	public function getGalleryItemsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GalleryPeer::DATABASE_NAME);
		}
		...
		if ($this->collGalleryItems === null) {
			if ($this->isNew()) {
				...
				$this->collGalleryItems = GalleryItemPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
