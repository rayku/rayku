...
abstract class BaseStatusPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new StatusMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StatusPeer::NAME);
	 ...
	 */
	public static function addInstanceToPool(Status $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the status table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in SalesPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
...
//
// NOTE: This static code cannot call methods on the StatusPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the StatusPeer class:
//
// Propel::getDatabaseMap(StatusPeer::DATABASE_NAME)->addTableBuilder(StatusPeer::TABLE_NAME, StatusPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseStatusPeer::DATABASE_NAME)->addTableBuilder(BaseStatusPeer::TABLE_NAME, BaseStatusPeer::getMapBuilder());
