...
abstract class BaseNetwork extends BaseObject  implements Persistent {
  ...
  const PEER = 'NetworkPeer';
	...
	/**
	 * Initializes internal state of BaseNetwork object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Network The current object (for fluent API support)
	 */
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = NetworkPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = NetworkPeer::DESCRIPTION;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = NetworkPeer::TYPE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = NetworkPeer::NUM_COLUMNS - NetworkPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = NetworkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			NetworkPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NetworkPeer::NAME)) $criteria->add(NetworkPeer::NAME, $this->name);
		if ($this->isColumnModified(NetworkPeer::DESCRIPTION)) $criteria->add(NetworkPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(NetworkPeer::TYPE)) $criteria->add(NetworkPeer::TYPE, $this->type);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Network (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Network Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Network has previously been saved, it will retrieve
	 * related Users from storage. If this Network is new, it will return
		...
		if ($this->collUsers === null) {
			if ($this->isNew()) {
			   $this->collUsers = array();
				...
				$criteria->add(UserPeer::NETWORK_ID, $this->id);
	 ...
	 * Otherwise if this Network is new, it will return
	 * an empty collection; or if this Network has previously
	 * been saved, it will retrieve related Users from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Network.
	 */
	public function getUsersJoinPicture($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(NetworkPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsers === null) {
			if ($this->isNew()) {
				...
				$this->collUsers = UserPeer::doSelectJoinPicture($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
