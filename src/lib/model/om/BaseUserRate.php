...
/**
 * Base class that represents a row from the 'user_rate' table.
 *
 * 
 *
...
abstract class BaseUserRate extends BaseObject  implements Persistent {
  ...
  const PEER = 'UserRatePeer';
	 ...
	 * Note: this column has a database default value of: 0.16
	 * @var        double
	 */
	protected $rate;
	...
	/**
	 * Initializes internal state of BaseUserRate object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserRatePeer::ID;
		}
	...
	public function setUserid($v)
	{
		...
		if ($this->userid !== $v) {
			$this->userid = $v;
			$this->modifiedColumns[] = UserRatePeer::USERID;
		}
	...
	public function setRate($v)
	{
		...
		if ($this->rate !== $v || $v === 0.16) {
			$this->rate = $v;
			$this->modifiedColumns[] = UserRatePeer::RATE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(UserRatePeer::RATE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = UserRatePeer::NUM_COLUMNS - UserRatePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			UserRatePeer::doDelete($this, $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UserRatePeer::doInsert($this, $con);
					...
					$affectedRows += UserRatePeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserRatePeer::ID)) $criteria->add(UserRatePeer::ID, $this->id);
		if ($this->isColumnModified(UserRatePeer::USERID)) $criteria->add(UserRatePeer::USERID, $this->userid);
		if ($this->isColumnModified(UserRatePeer::RATE)) $criteria->add(UserRatePeer::RATE, $this->rate);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UserRatePeer::ID, $this->id);
