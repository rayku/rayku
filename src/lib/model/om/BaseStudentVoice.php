...
/**
 * Base class that represents a row from the 'student_voice' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseStudentVoice extends BaseObject  implements Persistent {


  const PEER = 'StudentVoicePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        StudentVoicePeer
	 */
	...
	/**
	 * Initializes internal state of BaseStudentVoice object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     StudentVoice The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = StudentVoicePeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = StudentVoicePeer::USER_ID;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = StudentVoicePeer::TITLE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = StudentVoicePeer::DESCRIPTION;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = StudentVoicePeer::STATUS;
		}
	...
	public function setVote($v)
	{
		...
		if ($this->vote !== $v) {
			$this->vote = $v;
			$this->modifiedColumns[] = StudentVoicePeer::VOTE;
		}
	...
	public function setClassroomId($v)
	{
		...
		if ($this->classroom_id !== $v) {
			$this->classroom_id = $v;
			$this->modifiedColumns[] = StudentVoicePeer::CLASSROOM_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StudentVoicePeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StudentVoicePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->vote = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = StudentVoicePeer::NUM_COLUMNS - StudentVoicePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating StudentVoice object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = StudentVoicePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			StudentVoicePeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(StudentVoicePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(StudentVoicePeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
			StudentVoicePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = StudentVoicePeer::doInsert($this, $con);
					...
					$affectedRows += StudentVoicePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = StudentVoicePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = StudentVoicePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = StudentVoicePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setVote($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StudentVoicePeer::ID)) $criteria->add(StudentVoicePeer::ID, $this->id);
		if ($this->isColumnModified(StudentVoicePeer::USER_ID)) $criteria->add(StudentVoicePeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(StudentVoicePeer::TITLE)) $criteria->add(StudentVoicePeer::TITLE, $this->title);
		if ($this->isColumnModified(StudentVoicePeer::DESCRIPTION)) $criteria->add(StudentVoicePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(StudentVoicePeer::STATUS)) $criteria->add(StudentVoicePeer::STATUS, $this->status);
		if ($this->isColumnModified(StudentVoicePeer::VOTE)) $criteria->add(StudentVoicePeer::VOTE, $this->vote);
		if ($this->isColumnModified(StudentVoicePeer::CLASSROOM_ID)) $criteria->add(StudentVoicePeer::CLASSROOM_ID, $this->classroom_id);
		if ($this->isColumnModified(StudentVoicePeer::CREATED_AT)) $criteria->add(StudentVoicePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(StudentVoicePeer::UPDATED_AT)) $criteria->add(StudentVoicePeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(StudentVoicePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of StudentVoice (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     StudentVoice Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     StudentVoicePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new StudentVoicePeer();
		}
		return self::$peer;
	}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addStudentVoices($this);
			 */
		}
		return $this->aUser;
	}
	...
	public function getClassroom(PropelPDO $con = null)
	{
		if ($this->aClassroom === null && ($this->classroom_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aClassroom->addStudentVoices($this);
			 */
		}
	 ...
	 * Otherwise if this StudentVoice has previously been saved, it will retrieve
	 * related StudentVoiceVotess from storage. If this StudentVoice is new, it will return
		...
		if ($this->collStudentVoiceVotess === null) {
			if ($this->isNew()) {
			   $this->collStudentVoiceVotess = array();
				...
				$criteria->add(StudentVoiceVotesPeer::STUDENT_VOICE_ID, $this->id);
	 ...
	 * Otherwise if this StudentVoice is new, it will return
	 * an empty collection; or if this StudentVoice has previously
	 * been saved, it will retrieve related StudentVoiceVotess from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in StudentVoice.
	 */
	public function getStudentVoiceVotessJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(StudentVoicePeer::DATABASE_NAME);
		}
		...
		if ($this->collStudentVoiceVotess === null) {
			if ($this->isNew()) {
				...
				$this->collStudentVoiceVotess = StudentVoiceVotesPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
