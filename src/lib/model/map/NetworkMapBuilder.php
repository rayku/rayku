 ...
 */
class NetworkMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(NetworkPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(NetworkPeer::TABLE_NAME);
		$tMap->setPhpName('Network');
		$tMap->setClassname('Network');
