	function validate()
	{
		...
		{
			document.getElementById('error').style.display = "block";
			document.getElementById('error').innerHTML = 'Your password should be at least 6 characters';
			return false;
		}
		...
		{
			document.getElementById('error').style.display = "block";
			document.getElementById('error').innerHTML = 'Error: Rayku is currently available for certain schools only. Please use your @utoronto.ca or @ubc.ca email address.';
			return false;
		} 
